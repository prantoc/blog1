...
<form method="POST" action="{{ route($aroute) }}" enctype="multipart/form-data" >
   ...
   {{--          <div class="m-b-30">
            ...
            <div class="m-b-30">
             ...
             @if ($errors->has('work_id'))
                    ...
                    {{-- <label for="inputState" class="col-form-label">State</label> --}}
                      <select id="inputState" class="form-control" name="file_type">
            ...
            <textarea name="details" id="details" cols="82" rows="17"></textarea>
        ...
        <div class="col-md-4" id="seditor">
             ...
             <div class="form-group col-md-12 card-box dropzone"  id="myAwesomeDropzone">
                    ...
                    {{-- <input type="file" name="img" value="{{ old('img') }}" class="form-control" id="inputZip"> --}}
                     <input type="file" name="file" value="{{ old('img') }}" class="form-control" id="inputZip" multiple />
                </div>
