    ...
    <div class="row">
        ...
        <div class="col-md-8" id="meditor">
            ...
            <div class="m-b-30">
                ...
                <div class="form-group col-md-12 card-box">
                    ...
                    {{-- <img src="{{asset('upload/'.$news->img)}}" alt="" height="100" width="180"> --}}
               
                    <input type="file" name="img"  class="form-control">
                </div>

            {{-- <textarea name="details" id="details" cols="92" rows="17">{{$news->details }}</textarea> --}}
        ...
        <div class="col-md-4" id="seditor">
            ...
            <div class="card m-b-30 card-body">
                ...
                <h5 class="card-title">Update Pages</h5>
