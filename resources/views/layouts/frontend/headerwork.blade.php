      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
         <ul class="navbar-nav menu-pos">
            <li class="nav-item active">
               <a class="nav-link d-flex justify-content-end mr-2 work" href="{{route ('work')}}">work</a>
               <ul class="list-group list-group-horizontal navbar-nav mydropdown worksub-pos mr-4">
                  @foreach($works as $work)
                    <li class="nav-item ml-2 nav-item dropdown @if($work->slug == request()->route('slug') ) active @endif">
                      <a class="nav-link" href="{{route('all-work-single',$work->slug)}}">
                        {{$work->title}}
                  ...
                  @endforeach
                   ...
                   <li class="nav-item">
                    <a class="nav-link work-home home" href="{{route ('home')}}">home <span class="sr-only">(current)</span></a>
                  </li>
            </li>
         </ul>
      </div>
